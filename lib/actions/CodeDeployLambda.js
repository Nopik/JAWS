...
module.exports   = function(SPlugin, serverlessPath) {
  ...
  class Deployer {
    ...
    _validateAndPrepare() {
      ...
      _this.populatedFunction = _this.function.getPopulated({
        stage: _this.evt.options.stage,
        region: _this.evt.options.region
      });
        ...
        .then(function () {
          ...
          if (!_this.lambda) {
            ...
            let params = {
              ...
              Handler:      _this.populatedFunction.handler, /* required */
              Role:         _this.populatedFunction.customRole ? _this.populatedFunction.customRole : _this.meta.stages[_this.evt.options.stage].regions[_this.evt.options.region].variables.iamRoleArnLambda, /* required */
              Runtime:      _this.function.getRuntime().getName(), /* required */
              Description:  'Serverless Lambda function for project: ' + _this.project.name,
              MemorySize:   _this.populatedFunction.memorySize,
              Publish:      true, // Required by Serverless Framework & recommended best practice by AWS
              Timeout:      _this.populatedFunction.timeout,
              VpcConfig: {
                SecurityGroupIds: _this.populatedFunction.vpc.securityGroupIds,
                SubnetIds: _this.populatedFunction.vpc.subnetIds
              }
            };
            ...
            let params = {
              ...
              Description: 'Serverless Lambda function for project: ' + _this.project.name,
              Handler:      _this.populatedFunction.handler,
              MemorySize:   _this.populatedFunction.memorySize,
              Role:         _this.populatedFunction.customRole ? _this.populatedFunction.customRole : _this.meta.stages[_this.evt.options.stage].regions[_this.evt.options.region].variables.iamRoleArnLambda,
              Timeout:      _this.populatedFunction.timeout,
              VpcConfig: {
                SecurityGroupIds: _this.populatedFunction.vpc.securityGroupIds,
                SubnetIds: _this.populatedFunction.vpc.subnetIds
